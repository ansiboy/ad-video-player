...
const video_path_editor_1 = require("./property-editors/video-path-editor");
...
propertyEditors[type_names_1.typeNames.OneSplitView] = [
    {
        ...
        displayName: '播放时间',
        editorClass: input_editor_1.NumberInputEditor
    },
    {
        propertyName: CHILDREN,
        displayName: '分屏设置',
        editorClass: children_editor_1.ChildrenEditor
    }
];
...
propertyEditors[type_names_1.typeNames.ImagePlayer] = [
    {
        ...
        displayName: '图片路径',
        editorClass: (0, image_paths_editor_1.default)('image')
    }
];
...
propertyEditors[type_names_1.typeNames.VideoPlayer] = [
    {
        ...
        displayName: '视频路径',
        editorClass: video_path_editor_1.VideoEditor
    }
];
