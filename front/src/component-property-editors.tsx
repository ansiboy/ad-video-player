...
import CreateImagePathsEditorType from './property-editors/image-paths-editor'
import { VideoEditor } from './property-editors/video-path-editor'
...
propertyEditors[typeNames.OneSplitView] = [
  {
    propertyName: PLAY_SECONDS,
    displayName: '播放时间',
    editorClass: NumberInputEditor
  },
  {
    propertyName: CHILDREN,
    displayName: '分屏设置',
    editorClass: ChildrenEditor
  }
]

propertyEditors[typeNames.ThreeSplitView] = propertyEditors[
  typeNames.FourSplitView
] = propertyEditors[typeNames.OneSplitView]

let IMAGE_PATHS: keyof ImagePlayerProps = 'imagePaths'
propertyEditors[typeNames.ImagePlayer] = [
  {
    propertyName: IMAGE_PATHS,
    displayName: '图片路径',
    editorClass: CreateImagePathsEditorType('image')
  }
]
...
propertyEditors[typeNames.VideoPlayer] = [
  {
    propertyName: VIDEO_PATH,
    displayName: '视频路径',
    editorClass: VideoEditor
  }
]
